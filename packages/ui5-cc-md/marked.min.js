...
!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        ? define(t)
        : ((e = "undefined" != typeof globalThis ? globalThis : e || self).marked = t())
})(this, function () {
    "use strict"
    function i(e, t) {
            ...
            return (
                ...
                (t.heading = function (e) {
                    ...
                    if (t) {
                        ...
                        return (
                            /#$/.test(n) &&
                                ((e = O(n, "#")), (!this.options.pedantic && e && !/ $/.test(e)) || (n = e.trim())),
                            ...
                            if (((l = t = u[f]), f !== h - 1)) {
                                if (
                                    ...
                                    this.options.pedantic
                                        ? r[1].length > g[1].length
                                        : r[1].length > g[0].length || 3 < r[1].length)
                                ) {
                                    u.splice(f, 2, u[f] + "\n" + u[f + 1]), f--, h--
                                    continue
                                }
                ...
                (t.link = function (e) {
                    ...
                    if (t) {
                        ...
                        if (!this.options.pedantic && /^</.test(n)) {
                            ...
                            var r = j(t[2], "()")
                            ;-1 < r &&
                                ((s = (0 === t[0].indexOf("!") ? 5 : 4) + t[1].length + r),
                                    ...
                                    href:
                                        (r = /^</.test(r)
                                            ? this.options.pedantic && !/>$/.test(n)
                                                ? r.slice(1)
                                                : r.slice(1, -1)
                                            : r) && r.replace(this.rules.inline._escapes, "$1"),
    ...
    ;(R.punctuation = T(R.punctuation)
        ...
        (R.reflinkSearch = T(R.reflinkSearch, "g")
            .replace("reflink", R.reflink)
            .replace("nolink", R.nolink)
            .getRegex()),
        (R.normal = S({}, R)),
        (R.pedantic = S({}, R.normal, {
            strong: {
                start: /^__|\*\*/,
    ...
    var X = (function () {
            function n(e) {
                ...
                e = { block: D.normal, inline: N.normal }
                this.options.pedantic
                    ? ((e.block = D.pedantic), (e.inline = N.pedantic))
                    : this.options.gfm &&
                      ((e.block = D.gfm), this.options.breaks ? (e.inline = N.breaks) : (e.inline = N.gfm)),
            ...
            return (
                ...
                (r.inlineTokens = function (e, t, n, r) {
                    ...
                    for (; e; )
                        if ((l || (a = ""), (l = !1), (i = this.tokenizer.escape(e))))
                ...
                (t.code = function (e, t, n) {
                    ...
                    return (
                        !this.options.highlight ||
                            (null != (t = this.options.highlight(e, r)) && t !== e && ((n = !0), (e = t))),
                        (e = e.replace(/\n$/, "") + "\n"),
                        r
                            ? '<pre><code class="' +
                ...
                (e.parse = function (e, t) {
                    ...
                    for (var n, r, i, s, l, a, o, c, u, p, h, g, f, d, k, b = "", m = e.length, x = 0; x < m; x++)
                        switch ((c = e[x]).type) {
                            ...
                            case "list":
                                for (
                                    u = c.ordered, w = c.start, p = c.loose, i = c.items.length, o = "", n = 0;
                                    n < i;
                                    n++
                                )
